		...
		$( function() {
			...
			$("button").on("click" , function() {
				...
				if(id == null || id.length <1) {
					$('#not').remove();
					var view = "<span id='not' style='color:red'>ID를 입력하지 않으셨습니다.</span>";
					$('#userId').after(view);
					$("#userId").focus();
					return;
				}
				...
				if(pw == null || pw.length <1) {
					$('#not').remove();
					var view = "<span id='not' style='color:red'>패스워드를 입력하지 않으셨습니다.</span>";
					$('#password').after(view);
					$("#password").focus();
					return;
				}
...
// 					$('#not').remove();
// 					var view = "<span id='not' style='color:red'> <br>다시 확인해주세요.</span>";
			...
			<div class="wrapper fadeInDown">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-4 col-sm-6 text-center">
			      ...
			      <button type="button" class="btn btn-primary btn-lg btn-block" href="#" id="addButton">회 &nbsp;원 &nbsp;가 &nbsp;입</button>
			    </div>
			  </div>
			</div>
		</form>
